(function (global, factory) {
	...
	(global.restful = global.restful || {}, global.restful.js = factory());
...
var immutable_2 = immutable.List;
    ...
    return function endpointFactory(scope) {
        ...
        function _generateRequestConfig(method, data, params, headers) {
            ...
            if (data) {
                ...
                config = config.set('data', immutable_1(data));
            }
...
function scopeFactory(parentScope) {
    ...
    const scope = {
        ...
        get(key) {
            ...
            if (immutable_2.isList(parentDatum)) {
