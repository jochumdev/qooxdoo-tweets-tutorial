      ...
      _styleBackgroundImage: function _styleBackgroundImage(styles) {
        ...
        (function (images, repeats, tops, lefts, origins) {
          for (var i = 0; i < images.length; i++) {
            ...
            if (qx.core.Environment.get("qx.debug") && source && source.endsWith(".png") && (repeat == "scale" || repeat == "no-repeat") && qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9) {
