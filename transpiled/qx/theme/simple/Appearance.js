...
(function () {
  var $$dbClassInfo = {
    ...
    "implement": [],
    "hasDefer": null,
    "assets": ["qx/icon/Tango/16/apps/office-calendar.png", "qx/icon/Tango/16/places/folder-open.png", "qx/icon/Tango/16/places/folder.png", "qx/icon/Tango/16/mimetypes/text-plain.png", "qx/icon/Tango/16/actions/view-refresh.png", "qx/icon/Tango/16/actions/window-close.png", "qx/icon/Tango/16/actions/dialog-cancel.png", "qx/icon/Tango/16/actions/dialog-ok.png"]
  };
